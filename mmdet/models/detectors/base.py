...
class BaseDetector(nn.Module, metaclass=ABCMeta):
    ...
    def show_result(self,
        ...
        #color_masks = [(240, 248, 255), (250, 235, 215),(0, 255, 255),(127, 255, 212),(240, 255, 255),(245, 245, 220),(255, 228, 196),(0, 0, 255),(138, 43, 226),(165, 42, 42),
        # (222, 184, 135), (95, 158, 160), (127, 255, 0), (210, 105, 30), (100, 149, 237), (220, 20, 60)]
        color_masks = [(0, 0, 255), (255, 0, 0), (0, 255, 0), (255, 0, 255), (255, 0, 255), (0, 255, 255), (85, 107, 47), (143, 188, 143), (240, 128, 128), (25, 25, 112), 
                        (160, 82, 45), (208, 32, 144)]
        color_box = []
        if segm_result is not None and len(labels) > 0:  # non empty
            segms = mmcv.concat_list(segm_result)
            inds = np.where(bboxes[:, -1] > score_thr)[0]
            np.random.seed(42)
            color_masks = np.array(color_masks, dtype=np.uint8)
            #color_masks = [
        ...
        img = mmcv.imshow_det_bboxes(
            ...
            bbox_color=color_box,
            #text_color=tuple(color_masks),
            thickness=thickness,
